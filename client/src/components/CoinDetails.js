        ...
        <div className='CoinDetails'>
            {coinData ? (
                <div>
                    ...
                    <h2 style={{color: "green"}}>| 24H High: ${coinData && coinData.market_data ? coinData.market_data.high_24h.usd : null} | <span style={{color: "red"}}> | 24H Low: ${coinData && coinData.market_data ? coinData.market_data.low_24h.usd : null} |</span></h2>
